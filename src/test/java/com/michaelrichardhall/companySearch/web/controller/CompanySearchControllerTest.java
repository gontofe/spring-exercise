...
import com.michaelrichardhall.companySearch.web.dto.*;
...
class CompanySearchControllerTest {
    ...
    public void givenCompanySearchRequestWithName_whenCompanySearch_thenReturnCompanySearchResponse() throws Exception {
        ...
        when(companySearchService.getCompanyByCompanyName(anyString())).thenReturn(aCompanyList());
    ...
    public void givenCompanySearchRequestWithNameAndNumber_whenCompanySearch_thenReturnCompanySearchResponse() throws Exception {
        ...
        when(companySearchService.getCompanyByCompanyNumber(anyString())).thenReturn(aCompanyList());
